...
public class Withdrawal extends JFrame implements ActionListener{
    ...
    Withdrawal(String num)
    {
        setSize(800,800);
        setLayout(null);
        this.acnt=num;
        
         Title=new JLabel("Withdrawal");
       ...
       Title.setBounds(350,5, 400,75 );
        ...
        Topic1.setBounds(120,75,600,100);
           add(Topic1);
             ...
             Topic2=new JLabel("TO Withdraw in Multiples of 100");
        Topic2.setFont(new Font("Algerian",Font.BOLD,30));
        Topic2.setBounds(100,115,600,100);
           add(Topic2);
           ...
           Withdrawal.setBackground(java.awt.Color.RED);
           Withdrawal.setForeground(java.awt.Color.BLACK);
           Withdrawal.setBounds(210,275,150,60);
           add(Withdrawal);
    ...
    {
          Withdrawal obj=new Withdrawal("50409065368272");
    }
}
